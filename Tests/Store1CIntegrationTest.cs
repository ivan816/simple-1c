...
using System.Linq;
using Knopka.Application.Domain.BankAccounts;
using Knopka.Application._1C;
using Knopka.Application._1C.Mapper;
using Knopka.Application._1C.Mapper.Model.Документы;
using Knopka.Application._1C.Mapper.Model.Перечисления;
using Knopka.Application._1C.Mapper.Model.ПланыСчетов;
using Knopka.Application._1C.Mapper.Model.Справочники;
using Knopka.Application._1C.ObjectModel.Catalogs;
using Knopka.Application._1C.ObjectModel.Catalogs.BankAccounts;
using Knopka.Application._1C.ObjectModel.Catalogs.CounterpartContracts;
using Knopka.Application._1C.ObjectModel.Catalogs.Counterparts;
using Knopka.Application._1C.ObjectModel.Documents.AccountingDocuments;
using Knopka.Application._1C.ObjectModel.Enumerations;
using Knopka.Application._1C.ObjectModel.Queries;
using Knopka.Application._1C._1C.Domain;
using Knopka.Application._1C._1C.ObjectModel.Catalogs.BankAccounts;
using Knopka.Application._1C._1C.ObjectModel.Catalogs.CounterpartContracts;
using Knopka.Application._1C._1C.ObjectModel.Catalogs.Counterparts;
using Knopka.Application._1C._1C.ObjectModel.Catalogs.Nomenclatures;
using Knopka.Application._1C._1C.ObjectModel.Documents.AccountingDocuments;
using Knopka.Application._1C._1C.ObjectModel.Documents.AccountingDocuments.Incoming;
using NUnit.Framework;
using SimpleContainer.Infection;
using Bank = Knopka.Application._1C.ObjectModel.Catalogs.BankAccounts.Bank;

namespace Knopka.Tests.Application._1C.Store1CTests
{
    public class Store1CIntegrationTest : IntegrationTestBase
    {
        [Inject] public Store1C store1C;
