...
namespace LinqTo1C
{
    public class Store1C : IStore1C
    {
        ...
        public Store1C(GlobalContext globalContext, EnumMapper enumMapper,
            ComObjectMapper comObjectMapper)
        {
            this.globalContext = globalContext;
            this.enumMapper = enumMapper;
            this.comObjectMapper = comObjectMapper;
            queryProvider = RelinqHelpers.CreateQueryProvider(Execute);
        }
